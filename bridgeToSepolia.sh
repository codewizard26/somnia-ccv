...
# Script to bridge tokens from 0G Galileo Testnet to Sepolia
...
GALILEO_0G_ADDRESS="0x1Cd0690fF9a693f5EF2dD976660a8dAFc81A109c"
...
# Bridge the funds from Galileo to Sepolia
echo "Bridging the funds from Galileo to Sepolia..."
GALILEO_SENDER_ADDRESS=$(cast wallet address --private-key ${GALILEO_PRIVATE_KEY})
...
echo "Funds bridged from Galileo to Sepolia"
...
echo "✅ Bridge setup complete! Vault is deployed on Galileo and tokens can be bridged to Sepolia." 